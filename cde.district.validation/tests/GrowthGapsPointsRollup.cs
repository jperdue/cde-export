...
namespace cde.district.validation.tests
{
	public class GrowthGapsPointsRollup : BaseTest
	{
		public override void Test(Row row, List<string> errors)
		{
			...
			AssertSum(row, "RDPF_3YR_GG_PTS_ELIG_READ", new[] { "RDPF_3YR_GG_BPA_PTS_ELIG_READ", "RDPF_3YR_GG_ELL_PTS_ELIG_READ", "RDPF_3YR_GG_DIS_PTS_ELIG_READ", "RDPF_3YR_GG_MIN_PTS_ELIG_READ", "RDPF_3YR_GG_FRL_PTS_ELIG_READ" }, errors);

			AssertSum(row, "RDPF_1YR_GG_PTS_EARN_MATH", new[] { "RDPF_1YR_GG_BPA_PTS_EARN_MATH", "RDPF_1YR_GG_ELL_PTS_EARN_MATH", "RDPF_1YR_GG_DIS_PTS_EARN_MATH", "RDPF_1YR_GG_MIN_PTS_EARN_MATH", "RDPF_1YR_GG_FRL_PTS_EARN_MATH" }, errors);
