	...
	public class ParticipationRating : BaseTest
	{
		IEnumerable<Tuple<string, string, string>> ParticipationRateColumns
		{
			get
			{
                ...
                yield return new Tuple<string, string, string>("1YR_PARTIC_RATING_SOC", "1YR_PARTIC_PCT_TEST_SOC", "1YR_PARTIC_DN_SOC");
                ...
                yield return new Tuple<string, string, string>("3YR_PARTIC_RATING_SOC", "3YR_PARTIC_PCT_TEST_SOC", "3YR_PARTIC_DN_SOC");
			}
		}
