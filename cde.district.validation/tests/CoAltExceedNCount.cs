	...
	public class CoAltExceedNCount : BaseTest
	{
		IEnumerable<Tuple<string, string, string, string>> Columns
		{
			get
			{
                ...
                yield return new Tuple<string, string, string, string>("1YR_COALT_CAP_EXCD_SOC", "1YR_COALT_CAP_PA_N_SOC", "1YR_COALT_CAP_1PCTN_SOC", "1YR_COALT_CAP_NEXCD_SOC");
                ...
                yield return new Tuple<string, string, string, string>*"3YR_COALT_CAP_EXCD_SOC", "3YR_COALT_CAP_PA_N_SOC", "3YR_COALT_CAP_1PCTN_SOC", "3YR_COALT_CAP_NEXCD_SOC");
			}
		}
